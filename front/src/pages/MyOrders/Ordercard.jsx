  ...
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-gray-100 overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-gray-100 flex items-start justify-between gap-3">
        ...
        <span
          className={`shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border ${statusCfg.color}`}
        >
        ...
        <div className="space-y-2">
          ...
          {!expanded && order.items?.length > 2 && (
            ...
            >
              ...
              عرض {order.items.length - 2} منتجات أخرى
            </button>
          )}
          {expanded && (
            <button
