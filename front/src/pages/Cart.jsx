        ...
        {cartProducts.length === 0 ? (
          ...
          <>
            <div className="space-y-6 mb-12">
              {cartProducts.map((item) => (
                <div
                  ...
                  bg-white/10 flex-col sm:flex-row
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-lg font-bold mt-2">
                        السعر: ${Number(item.price).toFixed(2)}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 mt-6 sm:mt-0">
                    ...
                    <button
                      ...
                      className="bg-red-500/70 p-2 rounded-full
                      hover:bg-red-600 ml-4 transition-all"
                    >
            ...
            <div
              ...
              backdrop-blur-md p-8 rounded-3xl shadow-xl
